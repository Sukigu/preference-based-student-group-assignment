...
//			s2v2.run();
			...
			AssignmentProblem s2v4 = new AssignmentProblem(coursesFilename, s2InputPath + "turmas.csv", s2InputPath + "compostos.csv", s2InputPath + "escolhas.csv", s2InputPath + "médias.csv", 2, "4", true, s2v4OutputPath);
			s2v4.run();
		} catch (IOException e) {
			e.printStackTrace();
