...
//			s1v1.run();
			...
			AssignmentProblem s1v4 = new AssignmentProblem(s1InputPath + "turmas.csv", s1InputPath + "compostos.csv", s1InputPath + "escolhas.csv", s1InputPath + "médias.csv", "4", true, s1v4OutputPath);
			s1v4.run();
...
//			AssignmentProblem s2v2 = new AssignmentProblem(s2InputPath + "turmas.csv", s2InputPath + "compostos.csv", s2InputPath + "escolhas.csv", s2InputPath + "médias.csv", "2", false, s2v2OutputPath);
//			s2v2.run();
//			
//			String s2v4OutputPath = "res" + File.separator + "output" + File.separator + "s2v4" + File.separator;
//			AssignmentProblem s2v4 = new AssignmentProblem(s2InputPath + "turmas.csv", s2InputPath + "compostos.csv", s2InputPath + "escolhas.csv", s2InputPath + "médias.csv", "4", true, s2v4OutputPath);
//			s2v4.run();
		} catch (IOException e) {
			e.printStackTrace();
